 ...
 * @author PC
 */
public class MaterielHomeForm  extends BaseForm{
    Form current ; 
    public MaterielHomeForm(Resources res){
...
Add.addActionListener(e-> new MaterielForm(current,res).show()); 
List.addActionListener(e-> new ListMaterielForm(current,res).show());
...
List.addActionListener(e-> new ListeEvenementForm(current).show());
  ...
  /*  void addSideMenu(Resources res) {
    ...
    */
    ...
    public MaterielHomeForm(String title, Layout contentPaneLayout) {
