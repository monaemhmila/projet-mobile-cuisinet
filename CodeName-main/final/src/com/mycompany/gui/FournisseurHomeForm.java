 ...
 * @author PC
 */
public class FournisseurHomeForm  extends BaseForm{
    Form current ; 
    public FournisseurHomeForm(Resources res){
...
Button Add = new Button ("Fournisseur"); 
Button List = new Button ("Liste Fournisseur"); 
Add.addActionListener(e-> new FournisseurForm(current,res).show()); 
List.addActionListener(e-> new ListFournisseurForm(current,res).show());
...
List.addActionListener(e-> new ListeEvenementForm(current).show());
  ...
  /*  void addSideMenu(Resources res) {
    ...
    */
    ...
    public FournisseurHomeForm(String title, Layout contentPaneLayout) {
