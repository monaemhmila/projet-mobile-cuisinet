...
public class FournisseurForm extends BaseForm{
    ...
    public FournisseurForm(Form previous,Resources res) {
      ...
      //  Picker datePicker = new Picker();
        ...
        TextField Descfor = new TextField("","Descfor");
...
*/
     ...
     final String[] image_name = {""};
        ...
        {
            if((Descfor.getText().length()==0||tel.getText().length()==0||nom.getText().length()==0))
                Dialog.show("Alert", "Please fill all the fields " , new Command ("Ok")); 
            else {
            
            try{
            Fournisseur r = new Fournisseur((nom.getText()),(Descfor.getText()), (tel.getAsInt(BASELINE)));
            
            if(new ServiceFournisseur().add(r)){
                Dialog.show("Success", "Connection accepted", new Command("ok")); 
                new ListFournisseurForm(previous,res).showBack();
            }
            else 
        ...
        addAll(Descfor,tel , jobIcon, nom , btnValider) ; 
