...
public class ServiceMateriel {
    ...
    public boolean add(Materiel p) {
        String url = Static.BASE_URL + "/Ajoutermateriel?Descmat=" + p.getDescmat() + "&prix=" + p.getPrix() + "&nom=" + p.getNom();
 ...
 /*   public ArrayList<Evenement>affichageEvenement(){
    ...
    */
    ...
    public boolean deleteMateriel(int t) {
        String url = Static.BASE_URL + "/Deletemateriel?id=" + t;
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
    ...
    public boolean modifierMateriel(Materiel materiel) {
        String url = Static.BASE_URL +"/updateMateriel?idmat="+materiel.getIdmat()+"&DateDebut="+materiel.getDescmat()+"&prix="+materiel.getPrix()+"&nom="+materiel.getNom();
        req.setUrl(url);
