 ...
 * @author PC
 */
public class MaterielForm extends BaseForm{

    public MaterielForm(Form previous,Resources res) {
      ...
      //  Picker datePicker = new Picker();
        ...
        TextField Descmat = new TextField("","Descmat");
...
*/
     ...
     final String[] image_name = {""};
        ...
        {
            if((Descmat.getText().length()==0||prix.getText().length()==0||nom.getText().length()==0))
                Dialog.show("Alert", "Please fill all the fields " , new Command ("Ok")); 
            else {
            
            try{
            Materiel r = new Materiel((nom.getText()),(Descmat.getText()), (prix.getAsInt(BASELINE)));
            
            if(new ServiceMateriel().add(r)){
                Dialog.show("Success", "Connection accepted", new Command("ok")); 
                new ListMaterielForm(previous,res).showBack();
            }
            else 
        ...
        addAll(Descmat,prix , jobIcon, nom , btnValider) ; 
